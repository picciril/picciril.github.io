...
let handSpieler = [];
let handSpielerElement = document.getElementById("karten-spieler");

// Die Karten, die der Gegner zur verfügung hat.
let handGegner = [];
let handGegnerElement = document.getElementById("karten-gegner");
...
let spielStapel = [];
let spielfeldElement = document.getElementById("spielfeld");
...
function generiereLeereKarte() {
    // Erstelle das div Element.
    let kartenElement = document.createElement("div");
...
function generiereAufgedeckteKarte(karte) {
    // Erstelle das div Element.
    let kartenElement = document.createElement("div");
...
function versucheKarteZuSpielen(kartenNummer) {
...
function darfKarteGespieltWerden(karte) {
